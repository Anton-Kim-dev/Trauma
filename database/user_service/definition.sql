...
WITH doctor_data (user_id, specialty, first_name, last_name, patronymic, notes, is_active, work_days, shift_start, shift_end, slot_minutes) AS (
    VALUES
        ('3cb6e7a1-bfa2-4575-bc08-9606cac8c7ec'::UUID, 'Кардиология',        'Дмитрий', 'Иванов',    'Сергеевич',    'Ведет пациентов с нарушениями сердечного ритма и гипертонией', TRUE,  124, TIME '08:00', TIME '16:00', 30),
        ('fd1dab24-a90d-4e8e-b05c-92bcc1cb12e5'::UUID, 'Неврология',         'Алексей', 'Петров',    'Владимирович', 'Специализируется на мигренях и болевых синдромах',             TRUE,  124, TIME '09:00', TIME '17:00', 30),
        ('59edb842-9298-4bce-8938-ea1fffddc06e'::UUID, 'Ортопедия',          'Игорь',   'Сидоров',   'Николаевич',   'Консультирует по травмам суставов и восстановлению после них',  TRUE,  124, TIME '07:00', TIME '13:00', 45),
        ('6a382f85-9c61-4b23-bff4-e0c9bdd894ce'::UUID, 'Дерматология',       'Сергей',  'Кузнецов',  'Иванович',     'Принимает пациентов с аллергическими заболеваниями кожи',       FALSE, 124, TIME '10:00', TIME '16:00', 20),
        ('b2e60245-de8f-4064-b967-6fdee3c724b4'::UUID, 'Педиатрия',          'Андрей',  'Морозов',   'Павлович',     'Работает с детьми до 12 лет',                                    TRUE,  124, TIME '08:00', TIME '14:00', 20),
        ('0e5650f7-7eed-40a8-8745-3234db5dddaf'::UUID, 'Офтальмология',      'Ольга',   'Волкова',   'Дмитриевна',   'Проводит диагностику зрения и подбор терапии',                  TRUE,  124, TIME '09:00', TIME '17:00', 30),
        ('08e2b7d9-f1d2-4b07-8328-c3e9c870e2fd'::UUID, 'Эндокринология',     'Наталья', 'Новикова',  'Алексеевна',   'Ведет пациентов с сахарным диабетом и болезнями щитовидной железы', TRUE, 124, TIME '11:00', TIME '17:00', 30),
        ('500cf761-f6e5-474d-8a88-62648afd20ea'::UUID, 'Психиатрия',         'Елена',   'Соколова',  'Геннадьевна',  'Помогает при тревожных расстройствах и нарушениях сна',         FALSE, 124, TIME '13:00', TIME '19:00', 60),
        ('b22b321f-ee09-4974-a6dd-14a3a3852a64'::UUID, 'Гастроэнтерология',  'Ирина',   'Лебедева',  'Олеговна',     'Консультирует по заболеваниям желудка, печени и кишечника',      TRUE,  124, TIME '08:00', TIME '14:00', 30),
        ('af8fc80c-dbf4-4c0d-805e-9a58a40cd66b'::UUID, 'Терапия',            'Мария',   'Козлова',   'Юрьевна',      'Первичный прием, профилактика и маршрутизация пациента',         TRUE,  124, TIME '08:00', TIME '16:00', 15)
)
