...
export const SelectField = ({ description, error, label, options, required, ...props }: SelectFieldProps) => (
  <FieldShell description={description} error={error} label={label} required={required}>
...
export const TextareaField = ({ description, error, label, required, ...props }: TextareaFieldProps) => (
  <FieldShell description={description} error={error} label={label} required={required}>
